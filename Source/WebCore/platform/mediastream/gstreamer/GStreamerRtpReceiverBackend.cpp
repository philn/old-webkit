...
Ref<RealtimeMediaSource> GStreamerRtpReceiverBackend::createSource(RealtimeMediaSource::Type type)
{
    switch (type) {
    case RealtimeMediaSource::Type::Audio:
        return RealtimeIncomingAudioSourceGStreamer::create({});
    case RealtimeMediaSource::Type::Video:
        return RealtimeIncomingVideoSourceGStreamer::create({});
