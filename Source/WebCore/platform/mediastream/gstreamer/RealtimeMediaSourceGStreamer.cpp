...
const RealtimeMediaSourceCapabilities& GStreamerRealtimeMediaSource::capabilities() const
{
    if (!m_capabilities)
...
const RealtimeMediaSourceSettings& GStreamerRealtimeMediaSource::settings() const
{
