...
{
    initializeGStreamer();
    auto source = adoptRef(*new MockRealtimeAudioSourceGStreamer(deviceID));
...
MockRealtimeAudioSourceGStreamer::MockRealtimeAudioSourceGStreamer(const String& deviceID)
    : GStreamerRealtimeAudioSource({})
{
    GstElement* element = gst_element_factory_make("audiotestsrc", deviceID.utf8().data());
