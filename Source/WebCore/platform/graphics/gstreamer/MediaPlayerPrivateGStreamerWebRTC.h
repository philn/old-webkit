...
#ifndef MediaPlayerPrivateGStreamerWebRTC_h
#define MediaPlayerPrivateGStreamerWebRTC_h
...
class MediaPlayerPrivateGStreamerWebRTC : public MediaPlayerPrivateGStreamerBase, private MediaStreamTrackPrivate::Observer {
public:
    explicit MediaPlayerPrivateGStreamerWebRTC(MediaPlayer*);
    ~MediaPlayerPrivateGStreamerWebRTC();
...
private:
    ...
    String engineDescription() const final { return "GStreamerWebRTC"; }
...
#endif // MediaPlayerPrivateGStreamerWebRTC_h
